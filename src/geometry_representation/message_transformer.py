...
class MessageTransformer:
    ...
    def fiducial_analyser(cls, fiducialTransform):
        '''This function is charged to give the pose and id of the fiducial found if no error was detected'''
        return [fiducialTransform.fiducial_id, MessageTransformer.pose_from_transform(fiducialTransform.transform)]

    fiducial_analyser = classmethod(fiducial_analyser)